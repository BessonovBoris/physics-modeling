...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, Dialog, parent):
        ...
        self.horizontalSlider_3 = QtWidgets.QSlider(QtCore.Qt.Orientation.Horizontal, self.centralwidget)
        ...
        self.horizontalSlider_2 = QtWidgets.QSlider(QtCore.Qt.Orientation.Horizontal, self.centralwidget)
        ...
        self.horizontalSlider_4 = QtWidgets.QSlider(QtCore.Qt.Orientation.Horizontal, self.centralwidget)
        ...
        self.graph.Intensite(self.canvas, self.figure, self.horizontalSlider.value(), self.horizontalSlider_2.value(), self.horizontalSlider_3.value(), self.horizontalSlider_4.value(), self.comboBox.currentIndex())
        ...
        self.horizontalSlider.valueChanged['int'].connect(lambda: self.graph.Intensite(self.canvas, self.figure, self.horizontalSlider.value(), self.horizontalSlider_2.value(), self.horizontalSlider_3.value(), self.horizontalSlider_4.value(), self.comboBox.currentIndex()))
        ...
        self.horizontalSlider_2.valueChanged['int'].connect(lambda: self.graph.Intensite(self.canvas, self.figure, self.horizontalSlider.value(), self.horizontalSlider_2.value(), self.horizontalSlider_3.value(), self.horizontalSlider_4.value(), self.comboBox.currentIndex()))
        ...
        self.horizontalSlider_3.valueChanged['int'].connect(lambda: self.graph.Intensite(self.canvas, self.figure, self.horizontalSlider.value(), self.horizontalSlider_2.value(), self.horizontalSlider_3.value(), self.horizontalSlider_4.value(), self.comboBox.currentIndex()))
        ...
        self.horizontalSlider_4.valueChanged['int'].connect(lambda: self.graph.Intensite(self.canvas, self.figure, self.horizontalSlider.value(), self.horizontalSlider_2.value(), self.horizontalSlider_3.value(), self.horizontalSlider_4.value(), self.comboBox.currentIndex()))
        self.comboBox.currentIndexChanged['int'].connect(lambda: self.disableEnveloppe(self.comboBox.currentIndex() == 0))
        self.comboBox.currentIndexChanged['int'].connect(lambda: self.graph.Intensite(self.canvas, self.figure, self.horizontalSlider.value(), self.horizontalSlider_2.value(), self.horizontalSlider_3.value(), self.horizontalSlider_4.value(), self.comboBox.currentIndex()))
